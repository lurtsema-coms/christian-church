<script setup lang="ts">
    ...
    import { CircleArrowLeft, Save } from 'lucide-vue-next';
    ...
    const submit = () => {
        form.post(route('admin_calendar.store'));
    }
</script>
                                    ...
                                    <div class="flex-1 space-y-2">
                                        <div class="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                type="datetime-local"
                                            />
                                            <p v-if="form.errors.dateTime" class="mt-1 text-sm text-red-500">
