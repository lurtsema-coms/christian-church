...
const props = defineProps<{ sermon: any }>();

const sermonTitle = ref(props.sermon.title);
        ...
        <div class="pb-8">
            <form >
                <div class="max-w-4xl m-auto space-y-4">
                    ...
                    <div class="flex flex-col gap-4 sm:flex-row">
                        <div class="flex-1 space-y-2">
                            <label class="text-xs italic text-gray-500">Current Image: <span class="text-red-400"></span></label>
                            <img :src="sermonImage" alt="Image" class="w-full h-full rounded-t-lg md:max-w-md md:rounded-t-none lg:rounded-l-lg">
                        </div>
                        <div class="flex-1 space-y-2">
                            <label class="text-xs italic text-gray-500">Current Audio: <span class="text-red-400"></span></label>
